---
title: Pobierz certyfikaty użytkownika | Microsoft Docs
description: ''
keywords: ''
author: billmath
ms.author: billmath
...
ms.locfileid: "92760414"
---
# <a name="get-user-certificates"></a>Pobierz certyfikaty użytkowników
Pobiera listę certyfikatów, które są skojarzone z określonym użytkownikiem. Wycofane certyfikaty są filtrowane z listy.
...
Po pomyślnym zwraca listę obiektów [Microsoft. CLM. Shared. Certificates. X509ClmCertificate](https://msdn.microsoft.com/library/microsoft.clm.shared.certificates.x509clmcertificate(v=vs.100).aspx) z następującymi właściwościami:
...
Wystawca | Wystawca.
Nie później niż | Data i godzina, po której certyfikat nie jest już ważny.
Nie wcześniej niż | Data i godzina, o której certyfikat jest ważny.
RequesterName | Konto, które zażądało certyfikatu.
SerialNumber | Numer seryjny certyfikatu.
Stan | Stan certyfikatu.
TemplateCommonName | Nazwa pospolita szablonu certyfikatu dla certyfikatu.
Odcisk palca | Odcisk palca certyfikatu.

## <a name="example"></a>Przykład
Ta sekcja zawiera przykład uzyskiwania certyfikatów skojarzonych z użytkownikiem.
