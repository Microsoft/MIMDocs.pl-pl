# [Omówienie](microsoft-identity-manager-2016.md)
...
## [Proces obsługi usługi Azure AD](support-update-for-azure-active-directory-premium-customers.md)
...
## [Najlepsze rozwiązania](mim-best-practices.md)
...
## [Wdrażanie w środowiskach korzystających z protokołu TLS 1.2 lub trybu FIPS](preparing-tls.md)
## [Pierwsze wdrożenie](microsoft-identity-manager-deploy.md)
### [Konfiguracja domeny](preparing-domain.md)
### [Konfiguracja domeny pod kątem konta usługi zarządzanego przez grupę](preparing-domain-gmsa.md)
### [Konfiguracja serwera: Windows Server](prepare-server-ws2016.md)
### [Konfiguracja serwera: SQL](prepare-server-sql2016.md)
...
### [Instalacja podstawowa pakietu BHOLD](./bhold/bhold-core-installation.md)
### [Instalacja integracji pakietu BHOLD](./bhold/bhold-integration-installation.md)
### [Instalacja zaświadczania pakietu BHOLD](./bhold/bhold-attestation-installation.md)
### [Instalacja generatora modeli pakietu BHOLD](./bhold/bhold-model-generator-installation.md)
### [Instalacja raportowania pakietu BHOLD](./bhold/bhold-reporting-installation.md)
### [Instalacja analizy pakietu BHOLD](./bhold/bhold-analytics-installation.md)
### [Instalacja łącznika do zarządzania dostępem pakietu BHOLD](./bhold/bhold-access-management-connector-install.md)
...
## [Konfigurowanie łącznika programu Graph na potrzeby scenariusza B2B](microsoft-identity-manager-2016-graph-b2b-scenario.md)
## [Korzystanie z serwera usługi Azure MFA w usłudze PAM lub funkcji samoobsługowego resetowania hasła](working-with-mfaserver-for-mim.md)
## [Korzystanie z niestandardowego dostawcy uwierzytelniania wieloskładnikowego w usłudze PAM lub funkcji samoobsługowego resetowania hasła](working-with-custommfaserver-for-mim.md)
...
## [Analizator najlepszych rozwiązań](https://technet.microsoft.com/library/jj203402)
...
#### [Przewodnik dotyczący przepływu pracy łącznika usługi internetowej dla przykładowego interfejsu API REST](./reference/microsoft-identity-manager-2016-ma-ws-restgeneric.md)
#### [Usługa App Service przykładowego interfejsu API REST łącznika usługi internetowej](./reference/microsoft-identity-manager-2016-ma-ws-restsample.md)
...
### [Instrukcje krok po kroku dotyczące ogólnego łącznika SQL](./reference/microsoft-identity-manager-2016-connector-genericsql-step-by-step.md)
