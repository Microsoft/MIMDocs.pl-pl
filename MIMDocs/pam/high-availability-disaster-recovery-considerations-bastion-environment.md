...
## <a name="high-availability-and-disaster-recovery-scenarios"></a>Wysoka dostępność i odzyskiwanie po awarii — scenariusze
...
### <a name="trust-establishment"></a>Tworzenie relacji zaufania
...
### <a name="mim-administration"></a>Administracja programu MIM
...
### <a name="privileged-role-activation"></a>Aktywacja ról uprzywilejowanych
...
### <a name="deployments-supporting-multiple-sites"></a>Wdrożenia z obsługą wielu lokacji
...
### <a name="hosted-bastion-environment"></a>Hostowane środowisko bastionu
...
### <a name="sql-server-database-storage"></a>Magazyn bazy danych programu SQL Server
...
### <a name="mim-pam-components"></a>Składniki PAM programu MIM
